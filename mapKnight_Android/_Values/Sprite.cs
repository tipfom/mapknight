...
namespace mapKnight_Android
{
	public struct Sprite<T>
	{
		...
		public Sprite (string filename, Context GameContext, List<XMLElemental> filedefs) : this (GameContext.Resources.Assets.Open (filename), filedefs)
		{
			
		}

		public Sprite (Stream filestream, List<XMLElemental> filedefs) : this ()
		{
