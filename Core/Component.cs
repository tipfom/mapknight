...
namespace mapKnight.Core {
    public abstract class Component {
        ...
        public static Type GetComponentConfigType (Identifier type) {
            return Type.GetType($"mapKnight.Core.Components.Configs.{type.ToString( )}ComponentConfig");
        }

        public static Type GetIdentifier (Identifier type) {
            return Type.GetType($"mapKnight.Core.Components.{type.ToString( )}Component");
        }
        ...
        private class ComponentSerializationBinder : SerializationBinder {
            public override Type BindToType (string assemblyName, string typeName) {
                Type resolvingType = Type.GetType($"mapKnight.Core.Components.Configs.{typeName}ComponentConfig");
