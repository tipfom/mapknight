    ...
    public partial class MapEditor : UserControl {
        ...
        private Vector2 GetEntityCenterRaw (MouseEventArgs e) {
            ...
            Vector2 selectedTile = new Vector2(
                (float)Math.Max(0, Math.Min(positionOnControl.X / tilemapview.TileSize + tilemapview.Offset.X, currentMap.Width)),
                (float)Math.Max(0, Math.Min(currentMap.Size.Height - positionOnControl.Y / tilemapview.TileSize - tilemapview.Offset.Y, currentMap.Height)));
            return selectedTile;
        }
        ...
        private void HandleTilemapViewMoveEntities (object sender, MouseEventArgs e) {
            ...
            switch (currentTool) {
                ...
                case Tool.VectorGrabber:
                    ...
                    float rx = clickedPosition.X - tilemapview.Offset.X, ry = currentMap.Height - clickedPosition.Y - tilemapview.Offset.Y;
