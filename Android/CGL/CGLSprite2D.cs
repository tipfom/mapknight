...
namespace mapKnight.Android.CGL {
    public class CGLSprite2D : CGLTexture2D {
        public Dictionary<string, float[]> Sprites;

        public CGLSprite2D (Dictionary<string, int[]> content, int texture, string name, int width, int height) : base (texture, name, width, height) {
