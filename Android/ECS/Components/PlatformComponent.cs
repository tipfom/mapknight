...
namespace mapKnight.Android.ECS.Components {
    public class PlatformComponent : Component {
        ...
        public PlatformComponent (Entity owner, List<Vector2> waypoints, float speed) : base (owner) {
            ...
            this.waypoints.ForEach (waypoint => waypoint += owner.Transform.Center);
        }
        ...
        public override void Update (float dt) {
            ...
            Vector2 nextPosition = MathHelper.Interpolate (currentWaypoint, nextWaypoint, progressPercent);
