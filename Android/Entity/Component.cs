...
namespace mapKnight.Android.Entity {
    public abstract class Component {
        ...
        public static Type GetComponentConfigType (ComponentType type) {
            return Type.GetType ($"mapKnight.Android.Entity.Components.Configs.{type.ToString ()}ComponentConfig");
        }

        public static Type GetComponentType (ComponentType type) {
            return Type.GetType ($"mapKnight.Android.Entity.Components.{type.ToString ()}Component");
        }
