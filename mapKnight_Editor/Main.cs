...
namespace mapKnight_Editor
{
    public partial class Main : Form
    {
        ...
        private void initMapListView()
        {
            ...
            XMLElemental contentsonfig = XMLElemental.Load(File.OpenRead("content/config.xml"));
            foreach (XMLElemental child in contentsonfig.GetAll())
            {
                switch (child.Attributes["Type"])
                {
                    case "Tile":
                        ...
                        lvw_tiles.LargeImageList.Images.Add(child.Attributes["NumID"], new Bitmap(child.Attributes["Source"]));
                        break;
                    case "Overlay":
                        ...
                        lvw_overlays.LargeImageList.Images.Add(child.Attributes["NumID"], new Bitmap(child.Attributes["Source"]));
                        break;
                }
            }
