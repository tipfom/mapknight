...
namespace mapKnight_Editor
{
    public partial class Form1 : Form
    {
        ...
        {
            if (Map[x, y, 0] == replacementtile & Map[x, y, 1] == replacementoverlay) return;
        ...
        private void trb_imagesize_ValueChanged(object sender, EventArgs e)
        {
            ...
            OverlayImageList = new ImageList() { ImageSize = new Size(ListViewImageSize, ListViewImageSize), ColorDepth = ColorDepth.Depth32Bit };
            OverlayImageList.Images.AddRange(OverlayImages);
            TileImageList = new ImageList() { ImageSize = new Size(ListViewImageSize, ListViewImageSize), ColorDepth = ColorDepth.Depth32Bit };
