...
namespace mapKnight.Extended.Graphics.UI {
    public class UIWindow : Screen {
        ...
        private class UIWindowItem : UIItem {
            ...
            public UIWindowItem (Screen owner, Vector2 screenSize) : base(owner, new UIHorizontalCenterMargin(0f), new UIVerticalCenterMargin(0f), new RelativeSize(1f, 1f), UIDepths.BACKGROUND, false) {
