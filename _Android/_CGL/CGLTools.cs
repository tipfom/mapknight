...
#pragma warning disable 612, 618
        ...
        public static void LoadShader () {
            ...
            loadedShader.Add (Shader.FragmentShaderL, LoadShader (GL.GlFragmentShader, FragmentShaderLightningCode));
        }
        ...
        public static LoadedImage LoadImage (string assetpath) {
            int[] loadedtexture = new int[1];
            GL.GlGenTextures (1, loadedtexture, 0);

            BitmapFactory.Options bfoptions = new BitmapFactory.Options ();
            bfoptions.InScaled = false;
            Bitmap bitmap = BitmapFactory.DecodeStream (Content.Context.Assets.Open (assetpath), null, bfoptions);
        ...
        public static LoadedImage LoadImage (byte[] data) {
            int[] loadedtexture = new int[1];
            GL.GlGenTextures (1, loadedtexture, 0);
